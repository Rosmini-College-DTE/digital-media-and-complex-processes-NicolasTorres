...
func _process(delta):
	global.skeletonDamageAmount = damage_to_deal
	global.skeletonDamageZone = $SkeletonDealDamageArea
...
func move(delta):
	if !dead:
		...
		elif is_skeleton_chase and !taking_damage and global.playerAlive:
			speed = 50
...
func _on_skeleton_deal_damage_area_area_entered(area):
